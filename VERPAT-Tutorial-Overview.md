...
This tutorial describes the purpose, structure, and use of VERPAT (_V_ision_E_val _R_apid _P_lanning _A_ssessment _T_ool), a model based on the VisionEval framework for strategic planning.
